...
## Descrição
Checagem diária do projeto Acompanhamento VVV (Venice Token) — sentimento, cobertura asiática, regulatório e contrato.
...
ITENS:
1. Sentimento no X e Binance Square — tom predominante e mudança vs. dia anterior.
2. Qualquer cobertura asiática nova (Odaily, PANews, BlockBeats).
3. Qualquer notícia regulatória sobre IA / privacidade / uncensored.
4. Alerta se houver mudança em parâmetros do contrato (checar GoPlus / tokenomics, ex.: emissão/inflação, burn).

GATILHOS DE ALERTA (sinalizar 🔴 se ocorrer): deslistagem ou rumor regulatório; mudança de parâmetro de contrato; sentimento virando abruptamente.
